<template>
  <div class="faulty-terminal-container" ref="containerRef" />
</template>
...
const props = defineProps({
  ...
  digitSize: { type: Number, default: 1.2 },
  timeScale: { type: Number, default: 1 },
  pause: { type: Boolean, default: false },
  scanlineIntensity: { type: Number, default: 1 },
  ...
  dpr: { type: Number, default: () => Math.min(window.devicePixelRatio || 1, 2) },
  pageLoadAnimation: { type: Boolean, default: false },
