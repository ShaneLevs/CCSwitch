...
<template>
  ...
  />
  <Switch v-if="['claudeConfig', 'opencodeConfig', 'piConfig', 'ompConfig', 'reasonixConfig', 'commonConfig', 'installClaudeSkill', 'installOpencodeSkill', 'installCommonSkill', 'installPiExtension'].includes(route)" :route="route" :payload="payload" />
</template>
